...
export interface ClientControllerOptions {
  ...
  parcelWorkspace: ClientParcelProWorkspace;
...
export class ClientController {
  ...
  /** Parcel workspace */
  get parcelWorkspace(): ClientParcelProWorkspace {
    return this.options.parcelWorkspace;
  }

  /** Store that holds the parcels of the client */
  get parcelStore(): FeatureStore<ClientParcelPro> {
    return this.parcelWorkspace.parcelProStore;
  }

  /** Selected parcels */
  get selectedParcels(): ClientParcelPro[] { return this.selectedParcels$.value; }
  readonly selectedParcels$: BehaviorSubject<ClientParcelPro[]> = new BehaviorSubject([]);
  ...
  private filterParcelsByDiagrams(diagrams: ClientParcelDiagram[]) {
    ...
    const filterClause = function(parcel: ClientParcelPro): boolean {
  ...
  private initParcels() {
    this.parcels$$ = this.parcelStore
      .stateView.manyBy$((record: EntityRecord<ClientParcelPro>) => record.state.selected === true)
   ...
   */
  private onSelectParcels(parcels: ClientParcelPro[]) {
