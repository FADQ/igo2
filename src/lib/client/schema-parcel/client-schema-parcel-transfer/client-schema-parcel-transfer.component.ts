...
@Component({
  ...
  templateUrl: './client-schema-parcel-transfer.component.html',
  styleUrls: ['./client-schema-parcel-transfer.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ClientSchemaParcelTransferComponent implements WidgetComponent {
